...
@section('content')
    <div class="w-full max-w-xs mx-auto">
        ...
        <div class="flex items-center justify-between">
            <button class="bg-blue-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full" href="{{ route('logout') }}" onclick="event.preventDefault();
